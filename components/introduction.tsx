...
export default function Intro() {
  return (
    <section className='flex flex-col-reverse items-start gap-x-10 gap-y-4 pb-24 md:flex-row md:items-center'>
      ...
      <h1 className='text-4xl font-bold leading-tight text-black-800 md:text-6xl transition-colors duration-300 hover:text-yellow-500'>
  I&apos;m Ayele,
</h1>
  ...
  I am deeply committed to developing high-quality full-stack web applications and sharing my knowledge with others.
      ...
      <div className='relative flex flex-col items-center'>
        <Image
          ...
          priority
        />
<h2 className='mt-4 text-xl font-semibold text-black-600 transition-transform duration-300 hover:scale-105 hover:text-yellow-500'>
  Ayele Gobezie
  <span className='block h-0.5 w-0 bg-yellow-500 mt-1 transition-all duration-300 hover:w-full'></span>
</h2>
<p className='text-sm font-semibold text-black-600 transition-transform duration-300 hover:scale-105 hover:text-yellow-500'>
