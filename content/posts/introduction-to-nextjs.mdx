...
NextJs is a powerful React framework that makes it easy to build server-rendered React applications. 
This post has introduced you to the basics of NextJs and explained why you might want to use it in your projects.
